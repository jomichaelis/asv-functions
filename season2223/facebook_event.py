...
def create_image(home, guest, team_home, team_guest, rank_home, rank_guest, date, time, liga):
	...
	draw.text((600-text_width1/2, 380), text, (0, 0, 0), font=font_teams)

	# paste date
	# print(date, time)
	font_date = ImageFont.truetype(os.path.join(fonts_path, 'Manrope-Regular.ttf'), 32)
	...
	draw.text(((1200-liga_width)/2+2, 35), liga, (190, 176, 0), font=font_liga)
	draw.text(((1200-liga_width)/2, 34), liga, (0, 0, 0), font=font_liga)
