...
def create_image(home, guest, team_home, team_guest, rank_home, rank_guest, date, time, liga):
	...
	draw.text((1000-(home_team_width1/2), 1140), home_team_name, (255, 251, 0), font=font_teams)
	draw.text((1000-(minus_width1/2), 1260), minus, (255, 251, 0), font=font_teams)
	draw.text((1000-(guest_team_width1/2), 1380), guest_team_name, (255, 251, 0), font=font_teams)
	# TODO: Fix width of text if too long

	# paste date
	# print(date, time)
	font_date = ImageFont.truetype(os.path.join(fonts_path, 'ReadexPro-SemiBold.ttf'), 80)
	...
	draw.text((1000-(liga_width/2)+3, 152), liga, (0, 0, 0), font=font_liga)
	draw.text((1000-(liga_width/2), 150), liga, (255, 251, 0), font=font_liga)
